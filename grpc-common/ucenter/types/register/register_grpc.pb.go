...
type RegisterClient interface {
	...
	SendCode(ctx context.Context, in *CodeReq, opts ...grpc.CallOption) (*NogRes, error)
}
...
func (c *registerClient) SendCode(ctx context.Context, in *CodeReq, opts ...grpc.CallOption) (*NogRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NogRes)
...
type RegisterServer interface {
	...
	SendCode(context.Context, *CodeReq) (*NogRes, error)
...
func (UnimplementedRegisterServer) SendCode(context.Context, *CodeReq) (*NogRes, error) {
