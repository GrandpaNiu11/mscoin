...
func (x *NogRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NogRes) ProtoMessage() {}

func (x *NogRes) ProtoReflect() protoreflect.Message {
	mi := &file_register_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NogRes.ProtoReflect.Descriptor instead.
func (*NogRes) Descriptor() ([]byte, []int) {
...
const file_register_proto_rawDesc = "" +
	...
	"\acountry\x18\x02 \x01(\tR\acountry2r\n" +
	"\bRegister\x125\n" +
	"\x0fregisterByPhone\x12\x10.register.RegReq\x1a\x10.register.RegRes\x12/\n" +
	"\bsendCode\x12\x11.register.CodeReq\x1a\x10.register.NogResB\fZ\n" +
	"./registerb\x06proto3"
...
var file_register_proto_depIdxs = []int32{
	...
	3, // 4: register.Register.sendCode:output_type -> register.NogRes
