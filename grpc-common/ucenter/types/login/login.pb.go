...
const file_login_proto_rawDesc = "" +
	...
	"\x05token\x18\x02 \x01(\tR\x05token\"\xc6\x02\n" +
	"\bLoginRes\x12\x1a\n" +
	...
	"\x02id\x18\b \x01(\x03R\x02id\x12\x1e\n" +
	"\n" +
	"loginCount\x18\t \x01(\x05R\n" +
	"loginCount\x12\"\n" +
	"\fsuperPartner\x18\n" +
	" \x01(\tR\fsuperPartner\x12\x1e\n" +
	"\n" +
	"memberRate\x18\v \x01(\x05R\n" +
	"memberRate22\n" +
	"\x05Login\x12)\n" +
	"\x05login\x12\x0f.login.LoginReq\x1a\x0f.login.LoginResB\tZ\a./loginb\x06proto3"
